...
if ( ! function_exists( 'flat_post_nav' ) ) :
	function flat_post_nav() {
			...
			if ( ! $next && ! $previous )
					return;
			?>
			<div class="utility artclass"> <nav class="navigation post-navigation" role="navigation">
					<div class="row nav-links well">
						
						<div class="col-xs-6 borderwhite">

							<?php previous_post_link( '%link', _x( '<span class="meta-nav">&laquo;</span> %title', 'Previous post link', 'flat' ) ); ?>
						...
						<div class="col-xs-6">
							...
							<?php next_post_link( '%link', _x( '%title <span class="meta-nav">&raquo;</span>', 'Next post link', 'flat' ) ); ?>
